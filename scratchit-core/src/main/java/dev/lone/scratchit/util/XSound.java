...
@Deprecated //TODO: remove this shit and implement something to parse ENUM, if invalid then check if it's an NMS sound name, otherwise report error.
public enum XSound
{
    ...
    //new
    UI_CARTOGRAPHY_TABLE_TAKE_RESULT("UI_CARTOGRAPHY_TABLE_TAKE_RESULT", "STEP_SAND", "BLOCK_SAND_STEP"),
